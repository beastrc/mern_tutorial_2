...
module.exports = {
  ...
  SUCCESS_POST_REF: "You have successfully posted a referral",
  ...
  DELETE_ACCOUNT_FAILED: "Account can't be deleted. ",
  SUBSCRIPTION_NOT_EXIST: "You need to sign up subscription before you apply promo codes.",
  PROMO_CODE_NOT_EXIST: "The promo code you typed doesn't exist. Please type the correct promo code again.",
  PROMO_CODE_ALREADY_USED: "The promo code is used already. You can use ths promo code only one time.",
  GETRESPONSE_APIKEY: 'api-key rqhtb4ks26lbjr9tskx3yk434wrox5xg',
  GETRESPONSE_LISTNAME: 'imported-user-list',
  CHARGEBEE_SITE_NAME: 'legably-test',
  CHARGEBEE_SITE_KEY: 'test_0NurETbw7XhahhAMsjsIinyMRKoQcdPgw',
  SUBSCRIPTION_TIERS: {
  ...
  'RES_OBJ': {
    ...
    'MSG': {
      ...
      'IM_USED': 'IM Used',
      'EMAIL_REGITERED': 'This user is already registered in your network',
  ...
  'MAIL_OBJ': {
    ...
    'MAIL_TYPE': {
      ...
      'DELETE_ACCOUNT_SUCCEED_LEGABLY': 19,
      'DELETE_ACCOUNT_SUCCEED_USER': 20,
      'DELETE_ACCOUNT_FAILED': 21,
      'DELETE_PROJECT_SUCCEED_LEGABLY': 22,
      'DELETE_PROJECT_SUCCEED_USER': 23,
      'DELETE_PROJECT_FAILED': 24,
      'JOB_POSTED_TO_CANDIDATES': 25,
      'CHAT_MESSAGE_TO_RECEIVER': 26,
      'REF_POSTED_TO_CANDIDATES': 27,
      'EMAIL_ATTORNEY': 28,
      'BOOK_A_DEMO_USER': 29,
      'BOOK_A_DEMO_SUPPORT': 30,
      'REVIEW_EMAIL': 31
    }
  },
  'DELIVERABLE_STATUS': {
  ...
  'SUBSCRIPTION_PROMO_CODES':[
    {
      CODE_NAME: 'LGBY-7DAY',
      DESCRIPTION: '7 day trial before having to sign up for a subscription tier',
      TYPE: 'trial',
      VALUE: 7,
    },
    {
      CODE_NAME: 'LGBY-1MND',
      DESCRIPTION: '1 month subscription discount 13%',
      TYPE: 'discount',
      VALUE: 13,
    },
    {

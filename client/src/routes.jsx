...
import SubscriptionVerify from './components/SubscriptionVerify';
...
import Subscriptions_seeker from './components/subscriptions/Subscriptions_seeker';
...
import PostReferral from './components/dashboard/poster-referrals/PostReferral';
import PostedRefs from './components/dashboard/poster-referrals/PostedRefs';
import RespondedRefs from './components/dashboard/poster-referrals/RespondedRefs';
import SearchRefs from './components/dashboard/poster-referrals/SearchRefs';
import RefDetail from './components/dashboard/poster-referrals/RefDetail';
  ...
  <Router history={browserHistory}>
    <Route path="/" component={Layout}>
      ...
      <Route component={Authenticated}>
        ...
        <Route path={routesPath['SUBSCRIPTIONS_SEEKER']} component={Subscriptions_seeker} /> 
        ...
        <Route path={routesPath['PROJECT_SEARCH'] + '/:jobId'} component={JobDetail} />
        ...
        <Route path={routesPath['CHAT'] + '/:jobId'} component={MessageView} />
        <Route path={routesPath['NETWORK']} component={Network} />
        
        <Route component={SubscriptionVerify}>
          ...
          <Route path={routesPath['CANDIDATE_SEARCH'] + '/:jobId'} component={CandidateSearch} />
          <Route path={routesPath['POST_JOB']} component={PostAJob} />
          <Route path={routesPath['POST_PROJECT']} component={PostAJob} />
        </Route>
      </Route>

      <Route path={routesPath['POST_REFERRAL']} component={PostReferral} />
      <Route path={routesPath['MY_POSTED_REFS']} component={PostedRefs} />
      <Route path={routesPath['MY_RESPONDED_REFS']} component={RespondedRefs} />
      <Route path={routesPath['REF_SEARCH']} component={SearchRefs} />
      <Route path={routesPath['MY_POSTED_REFS'] + '/:refId'} component={RefDetail} />
      <Route path={routesPath['MY_RESPONDED_REFS'] + '/:refId'} component={RefDetail} />
      <Route path={routesPath['REF_SEARCH'] + '/:refId'} component={RefDetail} />

const ROUTES_PATH = {
  ...
  SUBSCRIPTIONS_SEEKER: '/subscriptions_seeker',
  CHECKOUT: '/checkout',
  ...
  MY_POSTED_REFS: '/my-posted-refs',
  MY_RESPONDED_REFS: '/my-responded-refs',
...
module.exports = {
  ...
  SUCCESS_RESPOND_REFERRAL: 'You have successfully responded to this referral request. The posting attorney will reply to you if they are interested in connecting further.',
  INVALID_LINKEDIN_LINK: 'Please enter a valid LinkedIn link',
  INVALID_FILE_FORMAT: 'Unsupported file format',
  ENTER_EMAIL: 'Please enter your email address',
  ENTER_EMAIL_ATTORNEY: 'Please enter email address',
  ...
  ENTER_FIRST_NAME_ATTORNEY: 'Please enter first name',
  ENTER_LAST_NAME_ATTORNEY: 'Please enter last name',
  ...
  SUBSCRIPTION_SUBTITLE_MONTH: "/ month + 2.5% of completed projects",
  SUBSCRIPTION_SUBTITLE_YEAR: "/ year + 2.5% of completed projects",
  SUBSCRIPTION_TIERS: {
    'post-1-project-for-free' : 0,
    'premium-job-seeker' : 1,
    '2-5-projects-month' : 2,
    '6-10-projects-month' : 3,
    '11-20-projects-month' : 4,
    'annual-plan-1' : 2,
    'annual-plan-2' : 3,
    'annual-plan-3' : 4,
  },
  ...
  POPUP_MSG: {
    ...
    DELETE_PROJECT:
      '<p class="text-left">Clicking the Confirm button below will remove your project from our database.</p><p class="text-left">If possible, please let us know the reasons behind your delete request.</p>',
    DELETE_ACCOUNT:
      '<p class="text-left">Clicking the Confirm button below will remove all of your account information from our database.</p><p class="text-left">If possible, please let us know the reason behind your delete request.</p>',
    LEAVE_ROLE:
    ...
    REF_POST_SUCCESS:
      'Your referral has been posted successfully.\nDo you want to create a new referral?',
    REF_UPDATE_SUCCESS: 'Your referral has been updated successfully.',
    ...
    CANCEL_SUBSCRIPTION:
      'We are sorry to see you go! Why are you leaving, and what could we do to improve your experience on Legably?',
    UPDATE_SUBSCRIPTION: 'Do you want to really update your subscription?',
    CANCEL_SCHEDULED_PLAN: 'Do you want to really cancel your scheduled subscription?',
    REMOVE_ATTORNEY: 'Do you want to really remove this attorney from your network?'
  },
  MESSAGES: {
    ...
    SUBSCRIPTION_SUCCESSFULLY_CANCELED:
    ...
    SUBSCRIPTION_SUCCESSFULLY_UPDATED:
  ...
  ACCESS_LEVEL: {
    '1-plan-project-month' : 1,
    '2-5-plan-project-month' : 2,
    '6-10-plan-project-month' : 3,
    '11-15-plan-project-month' : 4,
  },
  CHARGEBEE_SITE_NAME: 'legably-test',
  CHARGEBEE_SITE_KEY: '',
  API_URLS: {
    SIGN_UP: {
      name: '/signup',
    ...
    REMOVE_USER_IN_NETWORK: {
      name: '/removeUserInNetwork',
      type: 'post'
    },
    SIGN_IN: {
      name: '/login',
    ...
    // subscription
    STORE_SUBSCRIPTION_ON: {
      name: '/storeSubscription',
      type: 'post'
    },
    GET_SUBSCRIBED_PLAN: {
      name: '/getNewlySubscribedPlan',
      type: 'post'
    },
    CANCEL_SCHEDULED_PLAN: {
      name: '/cancelScheduledPlan',
      type: 'post'
    },
    SUBSCRIBED_PLAN: {
    ...
    UPDATE_SUBSCRIBED_PLAN: {
      name: '/updateSubscribedPlan',
      type: 'post'
    },
    SUBSCRIBE_PLANS: {
      name: '/getSubscribePlans',
      type: 'get'
    },
    GENERATE_CHECKOUT_NEW_URL: {
      name: '/generateCheckoutNewUrl',
      type: 'post'
    },
    // job seeker subscription
    GET_SUBSCRIBED_PLAN_SEEKER: {
      name: '/getNewlySubscribedPlanSeeker',
      type: 'post'
    },
    CANCEL_SCHEDULED_PLAN_SEEKER: {
      name: '/cancelScheduledPlanSeeker',
      type: 'post'
    },
    SUBSCRIBED_PLAN_SEEKER: {
      name: '/getSubscribedPlanSeeker',
      type: 'get'
    },
    UPDATE_SUBSCRIBED_PLAN_SEEKER: {
      name: '/updateSubscribedPlanSeeker',
      type: 'post'
    },
    CANCEL_SUBSCRIPTION_SEEKER: {
      name: '/cancelSubscriptionSeeker',
      type: 'post'
    },
    SUBSCRIBE_PLANS_SEEKER: {
      name: '/getSubscribePlansSeeker',
      type: 'get'
    },
    GENERATE_CHECKOUT_NEW_URL_SEEKER: {
      name: '/generateCheckoutNewUrlSeeker',
      type: 'post'
    },
    ...
    SET_AVAILABILITY_PROFILE: {
      name: '/posterAvailProfile',
      type: 'post'
    },
    CREATE_JOB: {
      name: '/postJob',
  ...
  AVAILABILITY_TYPE: {
    NOT_WORK: { label: 'Not available to work right now', id: 0 },
    FULL_TIME: { label: 'Available to work full-time', id: 1 },
    PART_TIME: { label: 'Available to work part-time', id: 2 },
    SHORT_TERM: { label: 'Available for short-term projects', id: 3 },
    NOT_VISIBLE: { label: 'Do not display my availability status', id: 4 }
  },
  IMG_PATH: '/images/',
  NO_DATA_SYMBOL: '-',
  SUPPORT_ID: SUPPORT_ID,
  MAX_UPLOAD_FILE_SIZE: 5000000,
  MAX_UPLOAD_FILE_COUNTS: 10,

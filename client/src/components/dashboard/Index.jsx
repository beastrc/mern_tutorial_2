...
export default class Dashboard extends React.Component {
  constructor (props) {
    ...
    this.state = {
      hideLeftPanel: false,
      selectedPage: constant['ROUTES_PATH']['PROJECT_SEARCH'],
      modalPopupObj: {}
    };
  }
            ...
            <nav id="sidebar" className="sidebar-fixed">
              ...
              {/* <li onClick={() => this.moveToPage(routesPath['JOB_SEARCH'], 'seeker')} className={selectedPage.includes(routesPath['JOB_SEARCH']) ? 'active' : ''}>
                ...
                */}
                ...
                <li onClick={() => this.moveToPage(routesPath['REF_SEARCH'], 'seeker')} className={selectedPage.includes(routesPath['REF_SEARCH']) ? 'active' : ''}>
                  <a>
                    <i className="fa fa-search" aria-hidden="true"></i>
                    Referrals
                  </a>
              ...
              {/* <li onClick={() => this.moveToPage(routesPath['POST_JOB'], 'poster')} className={selectedPage.includes('post-job') ? 'active' : ''}>
                ...
                <li onClick={() => this.moveToPage(routesPath['POST_REFERRAL'], 'poster')} className={selectedPage.includes('post-referral') ? 'active' : '' ? 'active' : ''}>
                  <a>
              ...
              {/*Sidebar Links*/} 
              <ul className="list-unstyled components">
                <li onClick={() =>  this.moveToPage(routesPath['MY_RESPONDED_REFS'], 'seeker')} className={selectedPage.includes(routesPath['MY_RESPONDED_REFS']) ? 'active' : ''}>
                  <a>
                    <i className="fa fa-briefcase" aria-hidden="true"></i>
                    REFERRAL OPPORTUNITIES</a>
                </li>
                <li onClick={() => this.moveToPage(routesPath['MY_POSTED_REFS'], 'poster')} className={(selectedPage.includes(routesPath['MY_POSTED_REFS']) || (selectedPage.includes('profile') && !selectedPage.endsWith('attorney') && !selectedPage.endsWith('firm'))) ? 'active' : ''}>
                  <a>
                    <i className="fa fa-briefcase" aria-hidden="true"></i>
                    POSTED REFERRALS</a>
                </li>

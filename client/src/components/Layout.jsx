...
class Layout extends React.Component {
  constructor(props, context) {
    ...
    this.handleBrowserListener = this.handleBrowserListener.bind(this);
  }

  componentDidMount() {
    this.handleBrowserListener();
      ...
      <html>
        <head>
          ...
          <meta
            name="Description"
            content={
              constant['SEO_META_INFO']['DESC'][this.props.location.pathname] ||
              ''
            }
          />

          <title>
            {constant['SEO_META_INFO']['TITLE'][this.props.location.pathname] ||
              'Legably'}
          </title>
          ...
          <script type="text/javascript" async
            src="//l.getsitecontrol.com/p4ryqkdw.js">
          </script>
        </head>
        <body>
          <noscript

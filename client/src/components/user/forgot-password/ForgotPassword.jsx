  ...
  render() {
    ...
    return (
      <div className="forgot-pwd-page-wrapper">
        { this.state.hideThankYou ? ( <section className="le_signright-row right-section forgot-pwd-section pull-right">
          <div className="form-wrapper">
          <h4 className="le-form-title le_f-bold le_text-center le_text-black">Sign In</h4>
            <p className="mb-30 le_f-normal le_text-center le_text-black">Please provide your registered email address to aid in the password recovery process.</p>
            <form className="forgot-pwd-form le_sign-in-form" onSubmit={this._handleClick} >
              <div className={this.state.formErrors.email !== '' ? 'form-group global-error' : 'form-group'}>
                ...
                <input type="text" className="email-id le_input-bg le_radius le_form-control" name="email"
          ...
          <section className="right-section reset-link-section pull-right">
            ...
            <div className="form-wrapper">
              ...
              <div className="btns">
                <button type="submit" onClick={() => utils.changeUrl(routesPath['SIGN_IN'])} className="btn reset-link-btn le_button-form">Continue to Sign In</button>
              </div>
            </div>
          </section>
        </div> )}

  ...
  componentDidMount() {
    ...
    return (
        ...
        <div className="static-panel-div">
          ...
          party.<br/><br/>
          Legably does not recommend any attorneys for referrals, projects, or any other feature on the Legably platform. Any fees processed for projects performed on the platform are for payment processing and other costs incurred by Legably in order to facilitate the transaction, and does not represent any sharing of attorney fees with a non-attorney.
          <br/><br/>

              ...
              <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div className="panel panel-default">
                  ...
                  <div id="collapseThree" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div className="panel-body">
                      Any attorney, who is licensed and in good standing in their licensing jurisdiction, may use Legably to complete projects and respond to referral requests. Anyone can post projects and hire attorneys to complete them.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">
                  <a className="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSixteen" aria-expanded="false" aria-controls="collapseSixteen">
                    <div className="panel-heading" role="tab" id="headingSixteen">
                      <h4 className="panel-title">
                        What is the difference between referrals and projects?
                      </h4>
                    </div>
                  </a>
                  <div id="collapseSixteen" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSixteen">
                    <div className="panel-body">
                      A referral is a client matter posted by another attorney who is looking for another lawyer to help with or handle. A referral is not processed on the Legably network, and users who respond to referrals simply message with the posting attorney and reach out to the client themselves. A project is completed on Legably, with the work being managed through the platform. Deliverables are uploaded and reviewed and payment is handled completely on the platform so that you don’t have to deal with the headache of managing the legal project and getting paid.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">
                ...
                <div className="panel panel-default">
                  ...
                  <div id="collapseFive" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                    <div className="panel-body">
                      Legably is free for attorneys to create profiles, search for work, apply to projects, and respond to referrals. Premium job seekers can apply for an unlimited number of projects and respond to an unlimited number of referrals per month. Check out our pricing page here (link to pricing page). Job posters pay for monthly, subscription-based access to post projects to the platform. Legably only takes a small percentage fee of the total budgeted work being performed in order to cover payment processing costs. This only happens once both attorneys have agreed to the total budget and the hiring attorney has been billed for the work.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default">

...
export default class SeekerBasicInfo extends React.Component {
  constructor(props) {
    ...
    this.createBarAdmissionContainer = this.createBarAdmissionContainer.bind(
      this
    );
      ...
      if (err) {
        ...
        if (utils.isResSuccess(response)) {
          ...
          for (let degreesObj of data['degrees']) {
            degrees.push(
              <option key={degreesObj['_id']} value={degreesObj['_id']}>
                {degreesObj['name']}
              </option>
            );
          }
  ...
  handleInfoSubmit(e) {
    ...
    switch ('street_address') {
      ...
      case 'first_name':
        if (this.state.formVal.first_name) {
          ...
          fieldValidationErrors.first_name = this.state.formVal.first_name.match(
            /^[a-zA-Z \-]+$/
          )
            ? ''
      ...
      case 'last_name':
        if (this.state.formVal.last_name) {
          ...
          fieldValidationErrors.last_name = this.state.formVal.last_name.match(
            /^[a-zA-Z \-]+$/
          )
            ? ''
            : constant.INVALID_LASTNAME;
        } else {
      ...
      case 'city':
        if (this.state.formVal.city) {
          ...
          fieldValidationErrors.city = this.state.formVal.city.match(
            /^[a-zA-Z ]+$/
          )
            ? ''
            : constant.INVALID_CITY_NAME;
        } else {
      ...
      case 'education_additional_information':
        for (var i = 0; i < this.state.formVal.education.length; i++) {
          if (
            this.state.formVal.education[i].education_additional_information
              .length > 250
          ) {
            fieldValidationErrors.education[
              i
            ].education_additional_information =
              constant.INVALID_ADD_INFO_LENGTH;
          } else {
            if (
              !fieldValidationErrors.education[i]
                .education_additional_information
            )
              fieldValidationErrors.education[
                i
    ...
    formObj.job_seeker_info.basic_profile.basic_info.street_address =
      formVal.street_address;
    formObj.job_seeker_info.basic_profile.basic_info.city = formVal.city;
    formObj.job_seeker_info.basic_profile.basic_info.state_id =
      formVal.state_id;
    formObj.job_seeker_info.basic_profile.basic_info.zipcode = formVal.zipcode;
    formObj.job_seeker_info.basic_profile.basic_info.phone_number =
      formVal.phone_number;
    ...
    formObj.job_seeker_info.basic_profile.practice_area_id =
      formVal.practice_area_id;
    formObj.job_seeker_info.basic_profile.skill_used_id = formVal.skill_used_id;
    formObj.job_seeker_info.basic_profile.do_you_have_malpractice_insurance =
      formVal.do_you_have_malpractice_insurance;
            ...
            if (err) {
              ...
              if (response.data.Code == 200 && response.data.Status == true) {
                if (callFrom == 'save') {
                  ...
                  utils.changeUrl(
                    constant['ROUTES_PATH']['SEEKER_EXEPERIENCE']
                  );
                }
              } else {
  ...
  validateField(fieldName, value, index) {
    ...
    switch (fieldName) {
      case 'first_name':
        if (value) {
          fieldValidationErrors.first_name = '';
          fieldValidationErrors.first_name = value.match(/^[a-zA-Z \-]+$/)
            ? ''
            : constant.INVALID_FIRSTNAME;
        } else {
          fieldValidationErrors.first_name = constant.ENTER_FIRST_NAME;
      ...
      case 'last_name':
        if (value) {
          fieldValidationErrors.last_name = '';
          fieldValidationErrors.last_name = value.match(/^[a-zA-Z \-]+$/)
            ? ''
            : constant.INVALID_LASTNAME;
        } else {
          fieldValidationErrors.last_name = constant.ENTER_LAST_NAME;
      ...
      case 'city':
        if (value) {
          fieldValidationErrors.city = '';
          fieldValidationErrors.city = value.match(/^[a-zA-Z ]+$/)
            ? ''
            : constant.INVALID_CITY_NAME;
        } else {
          fieldValidationErrors.city = constant.ENTER_CITY;
      ...
      case 'education_additional_information':
        if (
          this.state.formVal.education[index].education_additional_information
            .length > 250
        ) {
          fieldValidationErrors.education[
            index
          ].education_additional_information = constant.INVALID_ADD_INFO_LENGTH;
        } else {
          fieldValidationErrors.education[
            index
          ].education_additional_information = '';
  ...
  getUserProfile(isForceUpdateHeader) {
    ...
    utils.apiCall(
      ...
      function(err, response) {
        if (err) {
          ...
          if (response.data.Code == 200 && response.data.Status == true) {
            ...
            let basicInfo =
              response.data.Data.job_seeker_info.basic_profile.basic_info;

            formVal.first_name = response.data.Data.first_name
              ? response.data.Data.first_name
              : '';
            formVal.last_name = response.data.Data.last_name
              ? response.data.Data.last_name
              : '';

            formVal.street_address = basicInfo.street_address
            ...
            formVal.phone_number = basicInfo.phone_number
              ? basicInfo.phone_number
              : '';

            formVal.practice_area_id = basicProfile.practice_area_id
              ? basicProfile.practice_area_id
              : '';
            formVal.skill_used_id = basicProfile.skill_used_id
              ? basicProfile.skill_used_id
              : '';
       ...
       */
            formVal.do_you_have_malpractice_insurance = basicProfile.do_you_have_malpractice_insurance
              ? basicProfile.do_you_have_malpractice_insurance
              : 'Y';
        ...
        <div>
          <div className="visible-xs mobile-page-heading">
            ...
            <span
              ...
              className={
                this.state.completeStatus >= 1
                  ? 'next'
                  : 'next disabled-element'
              }
            ></span>{' '}
          </div>
          <form onSubmit={this.handleInfoSubmit}>
            <div className="basic-info-form">
              <div className="basic-info-card card">
                  ...
                  <div className="col-sm-6">
                    ...
                    >
                      ...
                      <input
                        ...
                        type="text"
                        name="first_name"
                        value={this.state.formVal.first_name}
                        id="fname"
                  ...
                  <div className="col-sm-6">
                    ...
                    >
                      ...
                      <input
                        ...
                        onBlur={this.handleInputOnBlur}
                        type="text"
                        value={this.state.formVal.last_name}
                        id="lname"
                        className="form-control"
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <div
                      className={
                        this.state.formErrors.street_address !== ''
                          ? 'form-group global-error'
                          : 'form-group'
                      }
                    >
                      ...
                      <textarea
                        onBlur={this.handleInputOnBlur}
                        name="street_address"
                        value={this.state.formVal.street_address}
                        onChange={this.handleUserInput}
                        className="form-control"
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div
                      className={
                        this.state.formErrors.state_id !== ''
                          ? 'form-group global-error'
                          : 'form-group'
                      }
                    >
                      ...
                      <div className="select-wrapper">
                        <select
                          ...
                          name="state_id"
                          value={this.state.formVal.state_id}
                          onChange={this.handleUserInput}
                ...
                <div className="row">
                  <div className="col-sm-6">
                    ...
                    >
                      ...
                      <input
                        ...
                        type="text"
                        name="zipcode"
                        value={this.state.formVal.zipcode}
                        id="zipcode"
                        onChange={this.handleUserInput}
                        className="form-control"
                  ...
                  <div className="col-sm-6">
                    ...
                    >
                      ...
                      <Mask
                        dataValue={this.state.formVal.phone_number}
                        isReverse={false}
                        mask={'000-000-0000'}
                        nameValue="phone_number"
                        placeholderValue="Phone Number"
                        onMaskBlur={this.handleInputOnBlur}
                        onMaskChange={this.getMaskedVal}
                      />
                      <p>
                        <span>
                          {this.state.formErrors.phone_number !== ''
                    ...
                    <div key={index}>
                      <div className="row">
                        <div className="col-sm-6">
                          <div
                            className={
                              this.state.formErrors.education[index].school !==
                              ''
                                ? 'form-group global-error'
                                : 'form-group'
                            }
                          >
                            ...
                            <input
                              ...
                              id="school"
                              name="school"
                              onBlur={e => this.handleInputOnBlur(e, index)}
                              key={index}
                              onChange={e => this.handleUserEduInput(index, e)}
                              value={item.school}
                              className="form-control"
                              placeholder="School"
                            />
                            <p>
                              <span>
                                {this.state.formErrors.education[index]
                                  .school !== ''
                                  ? this.state.formErrors.education[index]
                                      .school
                                  : ''}
                          ...
                          >
                            ...
                            <div className="select-wrapper">
                              <select
                                ...
                                onBlur={e => this.handleInputOnBlur(e, index)}
                                onChange={e =>
                                  this.handleUserEduInput(index, e)
                                }
                                name="degree_id"
                      ...
                      <div className="row">
                        <div className="col-sm-6">
                          <div
                            className={
                              this.state.formErrors.education[index].year !== ''
                                ? 'form-group global-error'
                                : 'form-group'
                            }
                          >
                        ...
                        <div className="col-sm-6">
                          ...
                          >
                            ...
                            <input
                              type="text"
                              onKeyDown={e => this.limit(248, e)}
                              id="add-info"
                              onChange={e => this.handleUserEduInput(index, e)}
                              onBlur={e => this.handleInputOnBlur(e, index)}
                              name="education_additional_information"
                              value={item.education_additional_information}
                              className="form-control"
                      ...
                      <div className="row add-more-wrapper">
                        <a
                          className={
                            index == this.state.formVal.education.length - 1
                              ? 'add-more'
                              : 'add-more d-none'
                          }
                          onClick={this.createEducationContainer}
                        >
                          <img
                        ...
                        <a
                          className={
                            index != 0 ? 'delete-more' : 'd-none delete-more'
                          }
                          onClick={e => this.deleteEdu(index, e)}
                        >
                          <img
                    ...
                    <div className="row" key={index}>
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          <div
                            className={
                              this.state.formErrors.bar_admission[index]
                                .bar_state_id !== ''
                                ? 'select-wrapper global-error'
                                : 'select-wrapper'
                            }
                          >
                            <select
                              ...
                              onBlur={e => this.handleInputOnBlur(e, index)}
                              onChange={e =>
                                this.handleUserBarAdInput(index, e)
                              }
                              name="bar_state_id"
                              value={item.bar_state_id}
                            >
                              <option value="">Select State</option>
                              {this.state.state_dropdown}
                            </select>
                      ...
                      <div className="col-sm-6">
                        ...
                        >
                          ...
                          <input
                            ...
                            onChange={e => this.handleUserBarAdInput(index, e)}
                            className="form-control uppercase"
                            placeholder="Bar Registration Number"
                            value={item.bar_registration_number}
                          />
                          <p>
                            <span>
                              {this.state.formErrors.bar_admission[index]
                      ...
                      <div className="row add-more-wrapper m-0">
                        <a
                          className={
                            index == this.state.formVal.bar_admission.length - 1
                              ? 'add-more'
                              : 'add-more d-none'
                          }
                          onClick={this.createBarAdmissionContainer}
                        >
                          <img
                            src={constant['IMG_PATH'] + 'add-more-icon.png'}
                            alt="add more"
                        ...
                        <a
                          className={
                            index !== 0 ? 'delete-more' : 'delete-more d-none'
                          }
                          onClick={e => this.deleteBar(index, e)}
                        >
                          <img
                            src={constant['IMG_PATH'] + 'delete-more.png'}
                            alt="delete more"
              ...
              <div className="practice-area-card card">
                ...
                <div className="row">
                  <div className="col-sm-6">
                    <div
                      className={
                        this.state.formErrors.practice_area_id !== ''
                          ? 'form-group global-error'
                          : 'form-group'
                      }
                    >
                  ...
                  <div className="col-sm-6">
                    <div
                      className={
                        this.state.formErrors.skill_used_id !== ''
                          ? 'form-group global-error'
                          : 'form-group'
                      }
                    >
                      ...
                      <Select
                        ...
                        onChange={value =>
                          this.logChangeSkills(value, 'skill_used_id')
                        }
                ...
                <div className="row">
                  <div className="col-sm-6">
                    <div
                      className={
                        this.state.formVal.showOthers == 'true' ||
                        this.state.formVal.showOthers == true
                          ? 'form-group'
                          : 'form-group d-none'
                      }
                    >
                      <label htmlFor="Others" className="control-label">
                        Other Skills
                      </label>
                      <input
                        value={this.state.formVal.others}
              ...
              <div className="malpractice-insurance-card card">
                ...
                <div className="row">
                  <div className="group-radio pl-15">
                    <div className="radio-label pb-10">
                      ...
                      <ul className="list radio-list m-0 p-0">
                        <li className="list__item">
                          <input
                            ...
                            type="radio"
                            className="radio-btn"
                            name="do_you_have_malpractice_insurance"
                            onChange={this.handleUserInput}
                            checked={
                              this.state.formVal
                                .do_you_have_malpractice_insurance === 'Y'
                            ...
                            value="Y"
                          />
                          <label htmlFor="yes" className="label p-0 m-0">
                            Yes
                          </label>
                        </li>
                        <li className="list__item">
                          <input
                            ...
                            value="N"
                          />
                          <label htmlFor="no" className="label p-0 m-0">
                            No
                          </label>
                        </li>
                      </ul>
              ...
              <div className="nxt-prev-btns">
                <div
                  className={
                    this.state.editProfile == true ? 'd-block' : 'd-none'
                  }
                >
                  <button
                    type="button"

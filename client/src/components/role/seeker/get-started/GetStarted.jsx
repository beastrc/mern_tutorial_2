          ...
          <div className="get-started-card card">
            ...
            <div className="row mb-35 v-center">
              ...
              <div className="col-sm-10">
                <p>Next, click <Link to={this.routesPath['PROJECT_SEARCH']} className="click-here">here</Link> to explore and apply for opportunities on Legably, manage your job search, and earn more-all online, all on the Legably dashboard.</p>
              </div>
            </div>
            <div className="row mb-35 v-center">
              <div className="col-sm-2 text-center">
